...
public class BoardTest {
    ...
    public void cellsArePlacedInRightSpot() {
        ...
        assertEquals(5, board.getCell(2, 4).getLetter());
        //First Position
        ...
        assertEquals(2, board.getCell(0, 0).getLetter());
        //Last Position
        Tile testTile3 = new Tile('Z', 3);
        board.setCell(14, 14, testTile1);
        assertEquals(testTile1, board.getCell(14, 14).getTile());
        assertEquals('Z', board.getCell(14, 14).getLetter());
        assertEquals(3, board.getCell(14, 14).getLetter());
    }
