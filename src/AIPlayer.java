...
public class AIPlayer extends Player {
    ...
    public boolean makeMove(gameModel model) {
        ...
        if (lastMove != null && !lastMove.isEmpty()) {
            ...
            if (sameCol) {
                ...
                if (maxRow + 1 < board.length && board[maxRow + 1][c0].isEmpty()) {
                    Character needed = findLetterToExtendRight(baseWord, getRack()); // "right" = add at end
                    if (needed != null) {
                ...
                if (minRow - 1 >= 0 && board[minRow - 1][c0].isEmpty()) {
                    Character needed = findLetterToExtendLeft(baseWord, getRack()); // "left" = add at front
                    if (needed != null) {
        ...
        // Just drop any highest-point tile on the first empty cell
